...
import CloseIcon from '@/app/ui/bigboard/CloseIcon';
import Football from './players/Football';
import { COLORS } from '../../styles';
import { getOrdinal } from '@/app/utils';
import { PickIsInModalContext } from '@/app/contexts';
import { PICKISIN_MODAL_INITIAL_VALUE } from '@/app/contexts/PickIsInModalContext/PickIsInModalContext';
  ...
  return visible ? (
    <Container onClick={(e) => e.stopPropagation()}>
      ...
      <Content>
        ...
        <Pick $bgUrl = {getTeamLogoUrl(abbv)} $colors={colors}>
          <FootballContainer>
            <Football
